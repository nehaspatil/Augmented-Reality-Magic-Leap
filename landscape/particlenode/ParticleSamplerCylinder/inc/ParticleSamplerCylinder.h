...
class ParticleSamplerCylinder final: public lumin::PrismController {
...
private:
	...
	UiText* m_titleNode;
	UiButton *m_playButton, *m_PropertiesButtonOuterRadius, *m_PropertiesButtonInnerRadius, *m_PropertiesButtonHeight;
